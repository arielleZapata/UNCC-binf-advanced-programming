...
if (graphX == "PCA1" && graphY == "PCA2") {
  ...
  jpeg("~/ABP-final/moveToIntelliJ/phylomorphospace_PCA.jpg", width = 1200, height = 1200, units = "px", res = 300)
  ...
  jpeg("~/ABP-final/moveToIntelliJ/phylomorphospace_noPCA.jpg", width = 1200, height = 1200, units = "px", res = 300)
